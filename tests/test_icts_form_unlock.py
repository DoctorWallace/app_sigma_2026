...
def test_proposal_create_rest_of_form_disabled_by_default(client):
    user = _create_icts_user("unlocker", "unlocker@example.com")
    ...
    assert 'id="rest-of-form" class="form-disabled"' in content
