...
urlpatterns = [
    ...
    path("reviews/send/<int:pk>/", views.review_send, name="review_send"),
    path("reviews/modify-request/<int:pk>/", views.review_request_modify, name="review_request_modify"),
    path("responsable/", views.responsable_dashboard, name="responsable_dashboard"),
    path("responsable/messages/", views.responsable_review_messages, name="responsable_review_messages"),
    path(
        "responsable/messages/<int:request_id>/approve/",
        views.approve_review_mod_request,
        name="approve_review_mod_request",
    ),
    path(
        "responsable/messages/<int:request_id>/deny/",
        views.deny_review_mod_request,
        name="deny_review_mod_request",
    ),
